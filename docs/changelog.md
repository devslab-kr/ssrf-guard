...
Drop in v3.1.1 — no consumer code changes. If your app exposes an LLM tool that takes a URL and you rely on `ssrf-guard-springai` / `ssrf-guard-langchain4j` to screen tool input, upgrade to pick up the fix.
